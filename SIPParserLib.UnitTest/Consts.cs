...
namespace SIPParserLib.UnitTest
{
	internal static class Consts
	{
		...
		public static string RequestLine3 = "INVITE sip:+33450050545@100.127.2.1;user=phone;BP=1086996 SIP/2.0\r\n";
		public static string HeaderLine3 = "Via: SIP/2.0/UDP 100.123.12.10:5060;branch=z9hG4bKac1724868430\r\nMax-Forwards: 69\r\nFrom: <sip:+33420100881@100.123.12.10;user=phone>;tag=1c2117732372\r\nTo: <sip:+33450050545@100.127.2.1;user=phone>\r\nCall-ID: 76142124176202294436@100.123.12.10\r\nCSeq: 1 INVITE\r\nContact: <sip:+33420100881@100.123.12.10:5060;x-i=93a8e31e-45f3-4a2c-ad9b-1307bd2264b5;x-c=079bc23e7abf5fb08d2a28ac79e30955/d/8/2151728ce5464326b645c333beb2fba9>\r\nSupported: 100rel,histinfo,sdp-anat\r\nAllow: INVITE,ACK,OPTIONS,CANCEL,BYE,NOTIFY\r\nUser-Agent: NXOCLOUD - Microsoft\r\nP-Asserted-Identity: <sip:+33420100881@100.123.12.10;user=phone>\r\nContent-Type: application/sdp\r\nContent-Length: 234\r\n";
		public static string Invite3 = "INVITE sip:+33450050545@100.127.2.1;user=phone;BP=1086996 SIP/2.0\r\nVia: SIP/2.0/UDP 100.123.12.10:5060;branch=z9hG4bKac1724868430\r\nMax-Forwards: 69\r\nFrom: <sip:+33420100881@100.123.12.10;user=phone>;tag=1c2117732372\r\nTo: <sip:+33450050545@100.127.2.1;user=phone>\r\nCall-ID: 76142124176202294436@100.123.12.10\r\nCSeq: 1 INVITE\r\nContact: <sip:+33420100881@100.123.12.10:5060;x-i=93a8e31e-45f3-4a2c-ad9b-1307bd2264b5;x-c=079bc23e7abf5fb08d2a28ac79e30955/d/8/2151728ce5464326b645c333beb2fba9>\r\nSupported: 100rel,histinfo,sdp-anat\r\nAllow: INVITE,ACK,OPTIONS,CANCEL,BYE,NOTIFY\r\nUser-Agent: NXOCLOUD - Microsoft\r\nP-Asserted-Identity: <sip:+33420100881@100.123.12.10;user=phone>\r\nContent-Type: application/sdp\r\nContent-Length: 234\r\n\r\nv=0\r\no=- 616920219 1669365097 IN IP4 100.123.12.10\r\ns=session\r\nc=IN IP4 100.123.12.10\r\nt=0 0\r\nm=audio 41676 RTP/AVP 8 97 101\r\na=ptime:20\r\na=rtpmap:8 PCMA/8000\r\na=rtpmap:97 RED/8000\r\na=rtpmap:101 telephone-event/8000\r\na=fmtp:101 0-15\r\n";

		public static string RequestLine4 = "ACK sip:+33663326291@185.221.88.177:5060;user=phone;sdp_iwf;transport=udp SIP/2.0\r\n";
		...
		public static string RequestLine5 = "ACK sip:100.127.2.1;transport=udp;sdp_iwf SIP/2.0\r\n";
		public static string ACK2 = "ACK sip:100.127.2.1;transport=udp;sdp_iwf SIP/2.0\r\nVia: SIP/2.0/UDP 100.123.12.10:5060;branch=z9hG4bKac788370192\r\nMax-Forwards: 69\r\nFrom: <sip:+33420100881@100.123.12.10;user=phone>;tag=1c2117732372\r\nTo: <sip:+33450050545@100.127.2.1;user=phone>;tag=SDh9b8697-1500190945-1655451878227\r\nCall-ID: 76142124176202294436@100.123.12.10\r\nCSeq: 1 ACK\r\nContact: <sip:+33420100881@100.123.12.10:5060;x-i=93a8e31e-45f3-4a2c-ad9b-1307bd2264b5;x-c=079bc23e7abf5fb08d2a28ac79e30955/d/8/2151728ce5464326b645c333beb2fba9>\r\nALLOW: INVITE,ACK,OPTIONS,CANCEL,BYE,NOTIFY\r\nUser-Agent: NXOCLOUD - Microsoft\r\nContent-Length: 0\r\n\r\n";
        ...
        public static string StatusLine4 = "SIP/2.0 180 Ringing\r\n";
        public static string HeaderLine4 = "To: <sip:0243444265@10.63.51.246;user=phone>;tag=SDlkqmf99-32404998-1657196912165\r\nFrom: <sip:0243444256@100.127.1.1;user=phone>;tag=805c39dd2baeee3bffc8428aefefcf0b\r\nCall-ID: da1a52791418607f7df917df392a0b02@10.63.51.246\r\nCSeq: 1052050797 INVITE\r\nVia: SIP/2.0/UDP 10.63.51.246;received=10.63.51.246;branch=z9hG4bK51a961c0007d0655a9525af08038540a;rport=5060\r\nAllow: INVITE,ACK,CANCEL,BYE,OPTIONS,UPDATE\r\nSupported: \r\nContact: <sip:100.127.1.1:5060;sdp_iwf;transport=udp>\r\nP-Asserted-Identity: <sip:0687756748@100.127.1.1;user=phone>\r\nPrivacy: none\r\nP-Early-Media: sendonly\r\nContent-Length: 0\r\n";
